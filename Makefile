...
build-i686-unknown-linux-gnu: ## Build dynamically linked binary in release mode for the x86_32 i686 architecture
	$(RUN) build-i686-unknown-linux-gnu
...
package-all: package-archive-all package-deb-all ## Build all packages
...
package-archive-all: package-archive-i686-unknown-linux-gnu
...
package-deb-all: package-deb-i686  ## Build all deb packages	

package-deb-i686: package-archive-i686-unknown-linux-gnu ## Build the x86_32 deb package
	$(RUN) package-deb-i686
